...
GUI.OptionsList = {
    ...
    [6] = { -- combat
        ...
        },
        {
            ...
            { 0.4, 2, 0.1 },
            nil,
            L['Changes the scaling of the combat alert.']
        },
        {
            3,
            'combatAlert',
            ...
            { 0.4, 2, 0.1 },
            nil,
            L['Changes the animation speed of the combat alert.']
        },
        {},
        {
            1,
    ...
    [9] = { -- map
        ...
        },
        {
            ...
            nil,
            nil,
            L['Clicking the middle mouse button on the minimap will bring up a menu with some commonly used functions.'],
        },
        {
            1,
            'Map',
