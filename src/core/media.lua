...
C.Assets = {
    Textures = {
        ...
        microMenu          = {
            achievement    = C.ASSET_PATH .. 'textures\\micromenu\\achievement',
            bag            = C.ASSET_PATH .. 'textures\\micromenu\\bag',
            calendar       = C.ASSET_PATH .. 'textures\\micromenu\\calendar',
            collection     = C.ASSET_PATH .. 'textures\\micromenu\\collection',
            encounter      = C.ASSET_PATH .. 'textures\\micromenu\\encounter',
            friend         = C.ASSET_PATH .. 'textures\\micromenu\\friend',
            guild          = C.ASSET_PATH .. 'textures\\micromenu\\guild',
            help           = C.ASSET_PATH .. 'textures\\micromenu\\help',
            lfg            = C.ASSET_PATH .. 'textures\\micromenu\\lfg',
            map            = C.ASSET_PATH .. 'textures\\micromenu\\map',
            character      = C.ASSET_PATH .. 'textures\\micromenu\\character',
            quest          = C.ASSET_PATH .. 'textures\\micromenu\\quest',
            spellbook      = C.ASSET_PATH .. 'textures\\micromenu\\spellbook',
            store          = C.ASSET_PATH .. 'textures\\micromenu\\store',
            talent         = C.ASSET_PATH .. 'textures\\micromenu\\talent',
        },
        ...
        inventory             = {
            ...
            fav     = C.ASSET_PATH .. 'textures\\inventory\\fav',
            ...
            warband = C.ASSET_PATH .. 'textures\\inventory\\config',
            bank    = C.ASSET_PATH .. 'textures\\inventory\\restack',
        },
    },
    Sounds = {
    ...
    Fonts = {
        Regular    = C.ASSET_PATH .. 'fonts\\Exo2-Medium.ttf',
        Bold       = C.ASSET_PATH .. 'fonts\\Exo2-Bold.ttf',
        Heavy      = C.ASSET_PATH .. 'fonts\\Exo2-Black.ttf',
        Condensed  = C.ASSET_PATH .. 'fonts\\AsapCondensed-SemiBold.ttf',
